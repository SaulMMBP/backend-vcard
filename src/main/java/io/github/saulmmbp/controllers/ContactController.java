...
public class ContactController {
	...
	@GetMapping
	public ResponseEntity<PagedModel<ContactModel>> getContactsByUserId(@PathVariable String userId, @PageableDefault Pageable pageable) {
	...
	public ResponseEntity<ContactResponseDto> getContactByIdAndUserId(@PathVariable Long contactId, @PathVariable String userId) {
		ContactResponseDto contact = contactService.getContactByIdAndUserId(contactId, userId);
		return ResponseEntity.ok(contact);
	}
	
	@PostMapping
	public ResponseEntity<ContactResponseDto> createContactForUser(@PathVariable String userId, @Valid @RequestBody ContactRequestDto contactRequest) {
		ContactResponseDto contact = contactService.createContactForUser(userId, contactRequest);
		return new ResponseEntity<>(contact, HttpStatus.CREATED);
	}
	
	@PutMapping("{contactId}")
	public ResponseEntity<ContactResponseDto> updateContactForUser(@PathVariable String userId, @PathVariable Long contactId, @Valid @RequestBody ContactRequestDto contactRequest) {
